    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'El gmail debe ser unico.'}, max_length=254, unique=True)),
                ('dni', models.IntegerField(verbose_name='D.N.I')),
                ('user_name', models.CharField(max_length=100, verbose_name='Nombres')),
